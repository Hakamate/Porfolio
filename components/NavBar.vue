<template>
  <div class="z-10 fixed md:sticky top-0 left-0 bottom-0 min-h-screen p-8 bg-gray-800 flex flex-col justify-between transform">
      ...
      <div class="grid gap1">
        <a v-for="(contact, indexc) in contacts" :key="indexc" rel="noopener" target="_blank" :href="contact.to" class="group mx-auto w-8 h-8 transition duration-500 hover:bg-primary rounded-full flex items-center justify-center">
