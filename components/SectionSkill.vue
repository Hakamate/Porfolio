<template>
    <div>
        <h2 class="text-4xl mb-16 font-bold leading-relaxed">MES <span class="text-primary">OUTILS ET COMPETENCES</span></h2>
        <div class="mt-10">
...
export default Vue.extend({
    ...
    methods: {
        elementMaj(element:string){
            if (element === 'htmll') { return 'Html' }
